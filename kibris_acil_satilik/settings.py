"""
Django settings for kibris_acil_satilik project.

Generated by 'django-admin startproject' using Django 5.0.

For more information on this file, see
deahttps://docs.djangoproject.com/en/5.0/topics/settings/
...
ROOT_URLCONF = 'kibris_acil_satilik.urls'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'kibris_acil_satilik.pagination.CustomPagination',
    'PAGE_SIZE': 10,
}
