...
class PropertyListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id','advertise_no', 'title', 'price', 'price_type', 'location_str', 'property_type','room_type','gross_area', 'cover_image_url', 'published_date')
...
class PropertyAdminCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    external_features = PropertyExternalFeatureSerializer(required=False)
    interior_features = PropertyInteriorFeatureSerializer(required=False)
    ...
    customer_id = serializers.UUIDField(write_only=True, required=True, source='customer')

    class Meta:
        model = PropertyAdvertisement
        exclude = ('id', 'user', 'advertise_no', 'created_at', 'updated_at', 'published_date')
